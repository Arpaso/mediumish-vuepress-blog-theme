---
title: Writing and reading a vuepress theme
date: 2019-5-6
tags:
- theme
- blog
...
summary: Mediumish is the best VuePress theme Medium styled (changed).

---
Create a `.vuepress/theme` directory in your docs root, and then create a `Layout.vue` file:
